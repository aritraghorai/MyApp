...
export function KeyboardShortcutsDialog({ open, onOpenChange }: KeyboardShortcutsDialogProps) {
    const shortcuts = [
        ...
        },
        {
            ...
            items: [
                { keys: ["Ctrl", "Shift", "K"], description: "Insert link" },
            ],
        },
        {
            category: "Editor",
                ...
                <div className="space-y-6 mt-4">
                    ...
                    <div className="mt-6 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                        <p className="text-sm text-gray-700 dark:text-gray-300">
                            ...
                            <code className="bg-white/50 dark:bg-gray-800/50 px-1 rounded">- [ ]</code> for todos
                            and add <code className="bg-white/50 dark:bg-gray-800/50 px-1 rounded">#high</code>,{" "}
                            <code className="bg-white/50 dark:bg-gray-800/50 px-1 rounded">#medium</code>, or{" "}
                            <code className="bg-white/50 dark:bg-gray-800/50 px-1 rounded">#low</code> for priority.
                        </p>
                    </div>
                </div>
            </DialogContent>
