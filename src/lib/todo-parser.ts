...
/*
*This funcation is deleting todo from note
*/
export function deleteTodoFromNote(noteContent: string, todoContent: string): string {
	const updatedContext = noteContent.split("\n").filter((line) => !line.includes(todoContent)).join("\n");
