...
import type { SaveStatus, SidebarView, ViewMode } from "@/types/mindspace/view.types";
...
interface NoteViewTemplateProps {
    // Header props
    viewMode: ViewMode;
...
/**
 * Template: Layout for note editing view
 */
