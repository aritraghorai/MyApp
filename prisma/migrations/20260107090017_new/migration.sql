...
CREATE TABLE "new_transactions" (
    ...
    CONSTRAINT "transactions_personId_fkey" FOREIGN KEY ("personId") REFERENCES "person" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_transactions" ("accountId", "amount", "billingCycle", "categoryId", "createdAt", "date", "description", "fromAccountId", "id", "personId", "type", "userId") SELECT "accountId", "amount", "billingCycle", "categoryId", "createdAt", "date", "description", "fromAccountId", "id", "personId", "type", "userId" FROM "transactions";
